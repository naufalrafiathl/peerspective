  ...
  return (
    ...
    >
      <div className="flex flex-col items-center">
        ...
        <p 
          className="text-sm text-center mx-8 font-sans text-gray-500 whitespace-normal md:whitespace-nowrap transition-colors duration-300 group-hover:text-white"
        >
          {description}
        </p>
      </div>
